...
let dictionaryData = [
    ...
    {word: "reisen", phonetic: "/ˈɻɜisɛn/", partOfSpeech: "v.", tense: "一般现在时", voice: "被动语态", definition: "控制；操纵（reis的被动形式）", example: "Dal line corisön kí atzēn reisen<br>心儿被她如冰雪般控制着融化"},
    // 形容词
